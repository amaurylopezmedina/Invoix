...
CREATE OR ALTER VIEW vFETablaDescuentosyRecargos AS
 SELECT 
        ...
        ('DESCUENTO DE '+trim(cast((td.cantidad *-1 )as varchar(10)))+' TOTAL:'+cast( (td.monto1 *-1) as varchar(20)))  as DescripcionDescuentooRecargo,
        '$' as TipoValor,
...
SElect * from  vFETablaDescuentosyRecargosEquipos