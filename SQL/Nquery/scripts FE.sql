...
alter table cxcmovi1 add ResultadoEstadoFiscal nvarchar(max)

	


Alter Table cliente add IdentificadorExtranjero int default 0
Go

Alter Table empresa add ambiente int default 0
Go

Alter table cxcmovi1 add MontoDGII Numeric(18,2)
Go
Alter table cxcmovi1 add MontoITBISDGII Numeric(18,2)
Go

Alter table producto add servicio int default 0
Go
update producto set servicio = 0
Go

Alter table producto add NotaImpresion nvarchar(max)
Go
...
EXEC sp_rename 'impuesto', 'impuestooldfe';
...
Alter Table transa01 add    CodigoSeguridadCF nvarchar(10) 
...
aLTER tABLE producto add NotaImpresion vvarchar(max)
