...
create or alter view vCajaChica as
...
SELECT 
    ...
    NULL as CodigoVendedor,
    NULL as NumeroPedidoInterno,
    NULL as ZonaVenta,
    NULL as RutaVenta,
    NULL as InformacionAdicionalEmisor,
    MAX(cc.fecha) as FechaEmision,
    NULL as RNCComprador,
    NULL as IdentificadorExtranjero,
    NULL as RazonSocialComprador,
    NULL as ContactoComprador,
    NULL as CorreoComprador,
    NULL as DireccionComprador,
    ...
    NULL as TelefonoAdicional,
    NULL as FechaOrdenCompra,
    NULL as NumeroOrdenCompra,
    NULL as CodigoInternoComprador,
    ...
    SUM(cc.grava) as MontoGravadoTotal,
    ...
    NULL as ITBIS2,
    NULL as ITBIS3,
    SUM(cc.itbis) as TotalITBIS,
    SUM(cc.itbis) as TotalITBIS1,
    NULL as TotalITBIS2,
    NULL as TotalITBIS3,
    ...
    NULL as MontoGravadoI1OtraMoneda,
    NULL as MontoGravadoI2OtraMoneda,
    NULL as MontoGravadoI3OtraMoneda,
    ...
    MAX(cc.concepto) as RazonModificacion,
    ...
    MAX(CONCAT(
        ...
        '&CodigoSeguridad=', [dbo].[FNCambiaHexadecimal](cc.CodigoSeguridad)
    )) as URLQR,
    NULL as Observaciones,
    NULL as Creadopor,
    NULL as ModificadoPor,
    NULL as NotaPermanente
FROM dbo.cajachica AS cc 
