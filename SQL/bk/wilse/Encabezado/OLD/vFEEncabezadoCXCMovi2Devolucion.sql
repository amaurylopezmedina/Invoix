...
SELECT
  ...
  */
  ...
  cxc2.Monto as  MontoGravadoTotal,
  cxc2.grava as MontoGravadoI1, --18
  null as MontoGravadoI2, -- 16
  cxc2.nograva as MontoGravadoI3,  -- Excento
  cxc2.nograva as MontoExento,
  CASE
    WHEN cxc2.grava <> 0 THEN 18 ELSE NULL
  END
  AS ITBIS1,
  NULL AS ITBIS2,
  CASE
    WHEN cxc2.nograva <> 0 THEN 0 ELSE NULL
  END
  ITBIS3,
  cxc2.impuesto as   TotalITBIS,
  cxc2.impuesto TotalITBIS1,
  null as TotalITBIS2,
  0 as TotalITBIS3,
    CASE
    WHEN cxc2.grava <> 0 THEN 1 ELSE 0
  END
  AS IndicadorMontoGravadoI18,
  0 AS IndicadorMontoGravadoI16,
  CASE
    WHEN cxc2.nograva <> 0 THEN 1 ELSE 0
  END
