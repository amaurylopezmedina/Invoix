SELECT
  ...
  (
    CASE
      ...
      WHEN cxc.tipomovi = '03' THEN 2
    END
  ) AS TipoPago,
  (
    CASE
      WHEN cxc.tipomovi = '' THEN 'Contado'
      WHEN cxc.tipomovi = '03' THEN 'Crédito'
    END
  ) AS TipoPagoL,
  ...
  (
    CASE
      WHEN cxc.tipo = '33'
      OR cxc.tipo = '34' THEN 'USD'
      WHEN cxc.tipo = '03'
      OR cxc.tipo = '04' THEN 'DOP'
      ELSE 'DOP'
    END
  ) AS TipoMoneda,
  (
    CASE
      WHEN cxc.tipoMOVI = '33'
      OR cxc.tipo = '34' THEN 'DOLAR ESTADOUNIDENSE'
      WHEN cxc.tipo = '03'
      OR cxc.tipo = '04' THEN 'PESO DOMINICANO'
