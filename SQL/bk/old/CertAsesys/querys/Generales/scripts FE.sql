...
Alter Table transa01 add  tasa numeric(18,2),  ConteoImpresiones int default 0,
transferencia numeric(18,4), observa3 char(254), ResultadoEstadoFiscal TEXT, MontoDGII numeric(18,4), 
MontoITBISDGII numeric(18,4)

Alter Table cxcmovi1 add ResultadoEstadoFiscal TEXT,CodigoSeguridadCF char(20),ConteoImpresiones int,
...
Alter Table cxcmovi2 add CodigoSeguridadCF char(20),ResultadoEstadoFiscal TEXT,SecSQL char(10), FVencimientoNCF datetime, ID INT IDENTITY(1,1),
EstadoFiscal int,Estadoimpresion int default 1, URLQR char(255),  
fechacreacion DATETIME DEFAULT GETDATE(), CodigoSeguridad char(255), Trackid char(255),  
FechaFirma char(50), RNCEmisor char(20)

Alter Table cxpmovi1 add ResultadoEstadoFiscal TEXT,CodigoSeguridadCF char(20),SecSQL char(10), FVencimientoNCF datetime, ID INT IDENTITY(1,1),
EstadoFiscal int, Estadoimpresion int default 1, URLQR char(255),  
fechacreacion DATETIME DEFAULT GETDATE(), CodigoSeguridad char(255), Trackid char(255),  
FechaFirma char(50), RNCEmisor char(20)

Alter Table cxpmovi2 add CodigoSeguridadCF char(20),ResultadoEstadoFiscal TEXT,SecSQL char(10), FVencimientoNCF datetime, ID INT IDENTITY(1,1),
EstadoFiscal int, Estadoimpresion int default 1, URLQR char(255),  
fechacreacion DATETIME DEFAULT GETDATE(), CodigoSeguridad char(255), Trackid char(255),  
FechaFirma char(50), RNCEmisor char(20)

Alter Table cxpmovi9 add CodigoSeguridadCF char(20),ResultadoEstadoFiscal TEXT,SecSQL char(10), FVencimientoNCF datetime, ID INT IDENTITY(1,1),
EstadoFiscal int, Estadoimpresion int default 1, URLQR char(255),  
fechacreacion DATETIME DEFAULT GETDATE(), CodigoSeguridad char(255), Trackid char(255),  
FechaFirma char(50), RNCEmisor char(20)

Alter Table cajachica add CodigoSeguridadCF char(20),ResultadoEstadoFiscal TEXT,SecSQL char(10), FVencimientoNCF datetime, ID INT IDENTITY(1,1),
EstadoFiscal int, Estadoimpresion int default 1, URLQR char(255),  
fechacreacion DATETIME DEFAULT GETDATE(), CodigoSeguridad char(255), Trackid char(255),  
FechaFirma char(50), RNCEmisor char(20)
