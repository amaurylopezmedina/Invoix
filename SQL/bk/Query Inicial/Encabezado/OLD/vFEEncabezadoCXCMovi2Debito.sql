--CXCMovi
CREATE OR ALTER VIEW vFEEncabezadoCXCMovi2Debito AS 
SELECT
  ...
  cxc2.ALMACEN AS Almacen,
    (
	CASE
      WHEN SUBSTRING(cxc2.ncf, 2, 2) = '34' AND DATEDIFF(DAY, tr.fecha, cxc2.fecha) >30 THEN 1	  ELSE 0
    END
...
WITH
  ...
  LEFT OUTER JOIN transa01 AS tr ON tr.ncf = cxc2.ncf1
  --LEFT OUTER JOIN td_1 ON 0  AS numero = cxc2.documento AND 0  AS tipo = '05'
WHERE
  (cxc2.tipomovi IN ( '05'))
