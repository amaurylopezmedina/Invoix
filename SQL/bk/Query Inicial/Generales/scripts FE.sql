...
Update empresa set RazonSocialEmisor = 'EQUIPOS TRANSPORTE Y SERVICIO JEP S R L'
Update empresa set NombreComercial = 'EQUIPOS TRANSPORTE Y SERVICIO JEP'
Update empresa set Sucursal = ''
Update empresa set DireccionEmisor = 'AUTOPISTA DUARTE KM 15, SANTIAGO, RD.'
Update empresa set MunicipioFE = ''
Update empresa set ProvinciaFE = ''
Update empresa set CorreoEmisor = ''
Update empresa set WebSite = ''
Update empresa set ActividadEconomica = 'ALQUILER DE EQUIPO DE TRANSPORTE PARA VÍA TERRESTRE, SIN OPERARIOS NI TRIPULACIÓN'
Update empresa set itbisenprecio = 0

/* Utilizar solo para implementados que tenga este campo tipo text
Alter table transa01 ALTER COLUMN  ResultadoEstadoFiscal varchar(max)
Alter table cxcmovi1 ALTER COLUMN  ResultadoEstadoFiscal varchar(max)
Alter table cxcmovi2 ALTER COLUMN  ResultadoEstadoFiscal varchar(max)
Alter table cajachica ALTER COLUMN  ResultadoEstadoFiscal varchar(max)
Alter table cxpmovi1 ALTER COLUMN  ResultadoEstadoFiscal varchar(max)
Alter table cxpmovi2 ALTER COLUMN  ResultadoEstadoFiscal varchar(max)
*/
...
go
 ...
 Go
 alter table empresa  add itbisenprecio char(1)
 Go
...
transferencia numeric(18,4), observa3 char(254), ResultadoEstadoFiscal varchar(max), MontoDGII numeric(18,4), 
...
alter  TABLE empresa ADD
	...
	[MunicipioFE] [varchar](6) NULL,
	[ProvinciaFE] [varchar](6) NULL,
...
--*****************************
-- hasta aqui correr los conmandos

----------------------------------------------------------------------------------------
-- Es muy imoportante en espe punto cambiae
--La tabla impuestos
--Actualizar la razon social y los campso nuevos de empresa
-----------------------------------------------------------------------------------------

--______________________________________________________________________________________________________________
--RESETEAR SECUENCIA PARA PONER LA SECUENCIA QUE LLEVE LA EMPRESA DE LOS NCF ACTUALES
--AJUSTAR LA SECUENCIA DE A UN VALOR ESPECIFICO
--PARA INICIAR UNA SLQ UTILIZADA HAY QUE PONER UN NUMERO MENOR A LA SEQ DESEADA
ALTER SEQUENCE E32 RESTART WITH 1;  
--PARA PONER UNA SEQ ADELANTADA, SI ES INCIAL NO EJECUTAR
SELECT NEXT VALUE FOR E32; 

-----------------------------------------------------------------------------------

select encf,FE,* from empresa
update empresa set encf=1
update empresa set fe=1

select ncf,SecSQL,EstadoFiscal,estadoimpresion,FVencimientoNCF, 
* from transa01 where fecha='20250127' order by fecha desc


ALTER SEQUENCE E32 RESTART WITH 1000;
SELECT NEXT VALUE FOR E32; 


 
SELECT * FROM secuenciasGlobales order by Prefijo
