...
ALTER DATABASE bscodeca01 SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
GO
-- Paso 2: Cambiar el cotejamiento
ALTER DATABASE bscodeca01 COLLATE Modern_Spanish_CI_AS;
GO
-- Paso 3: Volver al modo multiusuario
ALTER DATABASE bscodeca01 SET MULTI_USER;
GO



DECLARE @TableName NVARCHAR(128) = 'tradetalle'
DECLARE @TargetCollation NVARCHAR(128) = 'Modern_Spanish_CI_AS'
...
-- Imprime el script para revisar
PRINT @SQL
