...
SELECT
  ...
  '01' AS TipoIngresos,
  2 AS TipoPago,  -- Hay qeu poner que tome el tipo de la factura (a credito  oa contado)
...
FROM
 ...
 LEFT OUTER JOIN dbo.Transa01 AS tr1 WITH (nolock) ON tr1.numero = tr.documento and tr1.tipo IN ('04') -- Acceso a la factura a la que afecta
