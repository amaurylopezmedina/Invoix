...
SELECT
  ...
  CAST('' AS CHAR(1)) AS TipoCodigo2,
  CAST('' AS CHAR(1)) AS CodigoItem2,
  CAST('' AS CHAR(1)) AS TipoCodigo3,
  CAST('' AS CHAR(1)) AS CodigoItem3,
  CAST('' AS CHAR(1)) AS TipoCodigo4,
  CAST('' AS CHAR(1)) AS CodigoItem4,
  CAST('' AS CHAR(1)) AS TipoCodigo5,
  CAST('' AS CHAR(1)) AS CodigoItem5,
