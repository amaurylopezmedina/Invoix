...
def seleccionar_certificado():
    ...
    clave = simpledialog.askstring(
        "Contraseña", "Introduce la clave del certificado:", show="*"
    )

    try:
        #resultado = resumen_validez(ruta, clave, como_json=True)
        resultado = cargar_certificado(ruta, clave, como_json=True)
